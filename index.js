...
//Actividad
//1.Crea una coleccion de postman que llame a todas los endpoint
//2.Crea un endpoint nuevo GET /hola que devuelva:
// codigo 302 y 'Esto lo he escrito yo'
//3.Crea un endpoint nuevo GET /sobre-mi que devuelva:
// codigo 200 y la pagina sobre mi que esta en views
//Llama con Postman a estos endpoints
app.get("/hola", (req, res) => {
  res.status(302).send("Esto lo he escrito yo");
});
